...
class TestRAGContextSynthesizer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = patch('src.agents.dspy_programs.rag_context_synthesizer.configure_dspy_with_ollama')
    ...
    def test_initialization_without_compiled_program(self, mock_exists):
    ...
    def test_initialization_with_compiled_program(self, mock_load, mock_exists):

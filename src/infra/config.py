...
DEFAULT_CONFIG: dict[str, object] = {
    ...
    "DISCORD_DEFAULT_BROADCAST": False,
    ...
    "WORLD_TIME_BROADCAST_CADENCE_TICKS": 24,
    "TRAIT_DRIFT_SMOOTHING_WINDOW": 5,
    "TRAIT_DRIFT_SMOOTHING_ALPHA": 0.65,
    "TRAIT_DRIFT_HYSTERESIS_THRESHOLD": 0.0025,
    "CHARACTER_ARC_SUMMARY_WINDOW": 20,
    "DISCORD_CHARACTER_ARC_SUMMARIES": False,
}
...
FLOAT_CONFIG_KEYS = [
    ...
    "TRAIT_DRIFT_SMOOTHING_ALPHA",
    "TRAIT_DRIFT_HYSTERESIS_THRESHOLD",
]
INT_CONFIG_KEYS = [
    ...
    "WORLD_TIME_BROADCAST_CADENCE_TICKS",
    "TRAIT_DRIFT_SMOOTHING_WINDOW",
    "CHARACTER_ARC_SUMMARY_WINDOW",
]
BOOL_CONFIG_KEYS = [

...
examples = [
    # Innovator examples
    {
        ...
        "thought": "As an Innovator, I see this as an opportunity to propose a bold new approach—perhaps we can leverage serverless technology to bypass legacy constraints entirely."
    },
    {
        "role_name": "Innovator",
